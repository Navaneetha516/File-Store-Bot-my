...
class Config(object):
  ...
  BOT_TOKEN = os.environ.get("BOT_TOKEN", "6742978165:AAHvk0vkS1XogCkCMqeMvHpPL5pt7GhRD_A")
  BOT_USERNAME = os.environ.get("BOT_USERNAME", "http://t.me/Unlimited_File_Sharing_Bot")
  DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002115982151"))
  ...
  BANNED_USERS = set(int(x) for x in os.environ.get("BANNED_USERS", "-1002115982151").split())
  FORWARD_AS_COPY = bool(os.environ.get("FORWARD_AS_COPY", True))
  BROADCAST_AS_COPY = bool(os.environ.get("BROADCAST_AS_COPY", True))
  BANNED_CHAT_IDS = list(set(int(x) for x in os.environ.get("BANNED_CHAT_IDS", "-1002115982151").split()))
